...
function SplitterComponent({ children }: { children: ReactNode }) {
    ...
    const getGutter = () => {
        ...
        gutter.className = "relative h-full transition-all duration-200 before:absolute before:-left-2 before:w-5 before:h-full before:content-[''] before:bg-transparent before:cursor-e-resize md cursor-e-resizer hidden md:block";
