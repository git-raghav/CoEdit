...
function Sidebar() {
    ...
    return (
        <aside className="flex w-full md:h-full md:max-h-full md:min-h-full md:w-auto">
            <div
                className={cn(
                    "border-statuspurple fixed bottom-0 left-0 z-50 flex h-[50px] w-full gap-1 self-end overflow-hidden border-t bg-dark2 p-2 md:static md:h-full md:w-[50px] md:min-w-[50px] md:flex-col md:border-r md:border-t-0 md:p-2 md:pt-4",
                    {
            ...
            >
                ...
                <div className="flex h-fit items-center justify-center">
                    <button
                        className="flex items-center justify-center  rounded p-1.5 transition-colors duration-200 ease-in-out hover:text-gray-300"
                        onClick={changeState}
            ...
            <div
                className="absolute left-0 top-0 z-20 w-full flex-col bg-dark2 md:static md:min-w-[300px]"
