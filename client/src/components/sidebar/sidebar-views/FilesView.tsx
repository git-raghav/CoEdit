    ...
    return (
        ...
        >
            ...
            >
                <hr />
                <button
                    className="mt-1 flex w-full justify-start rounded-md p-2 text-sm transition-all hover:bg-dark"
                    onClick={handleOpenDirectory}
                    disabled={isLoading}
                >
                    <FolderUp className="mr-2" size={19} />
                    {isLoading ? "Loading..." : "Open File/Folder"}
                </button>
                <button
                    className="flex w-full justify-start rounded-md p-2 text-sm transition-all hover:bg-dark"
                    onClick={downloadFilesAndFolders}
                >
                    <FolderDown className="mr-2" size={19} /> Download Code as
                    ZIP
                </button>
            </div>
        </div>
