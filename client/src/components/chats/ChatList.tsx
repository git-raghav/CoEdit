...
function ChatList() {
    ...
    return (
        <div
            className="flex-grow overflow-auto rounded-lg bg-dark2 p-2"
            ...
            {messages.map((message, index) => {
                return (
                    <div
                        key={index}
                        className={
                            "mb-2 w-[80%] self-end break-words rounded-xl bg-darkHover px-3 py-2" +
                    ...
                    >
                        ...
                        <p className="py-1 text-base">{message.message}</p>
                    </div>
                )
            })}
        </div>
