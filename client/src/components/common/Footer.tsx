    ...
    return (
        <footer className="static bottom-1 left-0 flex w-full justify-center sm:fixed">
            ...
            <div className="group relative">
                <button onClick={() => window.open("https://github.com/git-raghav", "_blank", "noopener,noreferrer")} name="github">
                    <svg
                        ...
                        fill="none"
                        viewBox="0 0 24 24"
                        className="w-6 duration-200 hover:scale-125 hover:stroke-purple-500"
                    >
